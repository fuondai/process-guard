...
Tải phiên bản mới nhất từ trang [Releases](https://github.com/YourUsername/ProcessGuard/releases).

#### Cài đặt từ mã nguồn

```bash
# Sao chép kho lưu trữ
git clone https://github.com/YourUsername/ProcessGuard.git
cd ProcessGuard
...
Xem hướng dẫn cài đặt chi tiết hơn tại [Hướng dẫn cài đặt](docs/installation.md).
...
- Các nhà nghiên cứu bảo mật đã tài liệu hóa kỹ thuật Process Doppelgänging
- Cộng đồng Windows internals về các hiểu biết về cơ chế tạo tiến trình
- Tất cả các cộng tác viên đã giúp cải thiện dự án này

---

<p align="center">
Tạo ra với ❤️ dành cho cộng đồng bảo mật
</p>

```
doppelganger_detector/
├── main.py                 # Điểm vào chính
├── build.py                # Script tạo tệp thực thi
├── requirements.txt        # Thư viện phụ thuộc
├── README.md               # Tài liệu
└── modules/
    ├── __init__.py         # Khởi tạo package
    ├── scanner.py          # Quét tiến trình
    ├── monitor.py          # Giám sát tiến trình mới
    ├── logger.py           # Ghi log
    └── utils.py            # Các hàm tiện ích
```
...
Công cụ có thể được mở rộng để:
- Phân tích PE header của tiến trình khả nghi
- Dò các section bất thường trong bộ nhớ
- Kết nối với VirusTotal API để kiểm tra thêm
- Thêm chức năng cảnh báo hoặc tự động phản ứng
